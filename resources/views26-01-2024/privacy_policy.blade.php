        ...
        <div class="card rounded-0 shadow-none">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <p>
                        Welcome to <strong>Youngrads</strong>.
                    </p>
                    <p>
                        <strong>Youngrads</strong>
                        (“us”, “we”, or “our”) operates <strong>youngrads.com</strong> (hereinafter
                        referred to as <strong>“Service”</strong>).
                    </p>
                    <p>
                        Our Privacy Policy governs your visit to <strong>youngrads.com</strong>,
                    ...
                    <p>
                        ...
                        with us (<strong>“agreement”</strong>).
                    </p>
                    <h4 class="text-warning">Definitions</h4>
                    <p>
                        <strong>SERVICE</strong>
                        means the youngrads.com website operated by Youngrads.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        is data collected automatically either generated by the use of Service or
                    ...
                    <h4 class='text-warning'>Types of Data Collected</h4>
                    <p>
                        <strong>Personal Data</strong>
                    </p>
                    <p>
                        ...
                        you (<strong>“Personal Data”</strong>). Personally identifiable information
                    ...
                    <h4 class="text-warning">Usage Data</h4>
                    <p>
                        We may also collect information that your browser sends whenever you visit
                        our Service or when you access Service by or through any device ( <strong>“Usage Data”</strong>).
                    </p>
                    <p>
                    ...
                    <h4 class="text-warning">Location Data</h4>
                    <p>
                        We may use and store information about your location if you give us
                        permission to do so (<strong>“Location Data”</strong>). We use this data to
                    ...
                    <h4 class="text-warning">Tracking Cookies Data</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Other Data</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Use of Data</h4>
                    <p>
                        Youngrads uses the collected data for various purposes:
                    </p>
                    <p>
                    ...
                    <p>
                        1 to provide you with notices about your account and/or subscription,
                        including expiration and renewal notices, email-instructions, etc.;
                    </p>
                    <p>
                        1 to provide you with news, special offers and general information
                    ...
                    <h4 class="text-warning">Retention of Data</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Transfer of Data</h4>
                    <p>
                    ...
                    <p>
                        Youngrads will take all the steps reasonably necessary to ensure that your
                    ...
                    <h4 class="text-warning">Disclosure of Data</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Security of Data</h4>
                    <p>
                    ...
                    <p>
                        ...
                        want it to be removed from our systems, please email us at <a href="mailto:support@youngrads.com"><strong>support@youngrads.com</strong></a>.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        a copy of your Personal Data in a structured, machine-readable and commonly
                        used format;
                    </p>
                    <p>
                    ...
                    <p>
                         ...
                         <a href="mailto:support@youngrads.com"><strong>support@youngrads.com</strong></a>.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        send your request(s) by email: <a href="mailto:support@youngrads.com"><strong>support@youngrads.com</strong></a>.
                    </p>
                    <p>
                    ...
                    <h4 class="text-warning">Service Providers</h4>
                    <p>
                    ...
                    <h4 class="text-warning">CI/CD tools</h4>
                    <p>
                        We may use third-party Service Providers to automate the development
                        process of our Service.
                    </p>
                    <h4 class="text-warning">Behavioral Remarketing</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Payments</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Links to Other Sites</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Children’s Privacy</h4>
                    <p>
                    ...
                    <p>
                        ...
                        Children under 1 If you become aware that a Child has provided us with
                    ...
                    <h4 class="text-warning">Changes to This Privacy Policy</h4>
                    <p>
