        ...
        <div class="card rounded-0 shadow-none">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <p>
                        Welcome to <strong>Youngrads</strong> (“Company”, “we”, “our”, “us”)!
                    </p>
                    <p>
                        These Terms of Service (“Terms”, “Terms of Service”) govern your use of our
                        website located at <strong>youngrads.com</strong> (together or individually
                        “Service”) operated by <strong>Youngrads</strong>.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        not use the Service, but please let us know by emailing at <strong>support@ygrads.com</strong> so we
                        can try to
                        find a solution. These
                        Terms apply to all visitors, users and others who wish to access or use
                        Service.
                    </p>
                    <h4 class="text-warning">Communications</h4>
                    <p>
                        ...
                        following the unsubscribe link or by emailing at support@ygrads.com.
                    </p>
                    <h4 class="text-warning">Contests, Sweepstakes and Promotions</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Content</h4>
                    <p>
                    ...
                    <p>
                        <strong>Youngrads</strong>
                        has the right but not the obligation to monitor and edit all Content
                        provided by users. In addition, Content found on or through this Service
                        are the property of <strong>Youngrads</strong> or used with permission. You
                    ...
                    <h4 class="text-warning">Prohibited Uses</h4>
                    ...
                    <h4 class="text-warning">Analytics</h4>
                    </p>
                    <p>
                        We may use third-party Service Providers to monitor and analyze the use of
                        our Service.
                    </p>
                    <h4 class="text-warning">No Use By Minors</h4>
                    ...
                    <h4 class="text-warning">Intellectual Property</h4>
                    <p>
                        Service and its original content (excluding Content provided by users),
                        features and functionality are and will remain the exclusive property of <strong> Youngrads</strong>
                        and its
                        ...
                        without the prior written consent of <strong>Youngrads</strong>.
                    </p>
                    <h4 class="text-warning">Copyright Policy</h4>
                    ...
                    <p>
                        ...
                        support@ygrads.com, with the subject line: “Copyright Infringement” and
                    ...
                    <p>
                        You can contact our Copyright Agent via email at support@ygrads.com.
                    </p>
                    <h4 class="text-warning">Error Reporting and Feedback</h4>
                
                    <p>
                        You may provide us either directly at support@ygrads.com or via third party
                    ...
                    <h4 class="text-warning">Links To Other Web Sites</h4>
                    <p>
                        Our Service may contain links to third party web sites or services that are
                        not owned or controlled by <strong>Youngrads</strong>.
                    </p>
                    <p>
                        <strong>Youngrads</strong>
                    ...
                    <h4 class="text-warning">Disclaimer Of Warranty</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Limitation Of Liability</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Termination</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Governing Law</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Changes To Service</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Amendments To Terms</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Waiver And Severability</h4>
                    <p>
                    ...
                    <h4 class="text-warning">Acknowledgement</h4>
                    <p>
                    ...
                    <p>
                        ...
                        email: <a href="mailto:support@youngrads.com"><strong>support@youngrads.com</strong></a>.
                    </p>
                </div>
            </div>
        </div>
