    ...
    <nav class="header-navbar navbar-expand-lg navbar navbar-with-menu {{ $configData['navbarColor'] }} navbar-fixed">
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item"><a class="navbar-brand" href="{{ route('my-account') }}">
    ...
    <div class="navbar-container content">
        <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
                ...
                <li class="dropdown dropdown-notification nav-item d-none"><a class="nav-link nav-link-label"
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header m-0 p-2">
                                <h3 class="white">5 New</h3><span class="white darken-2">App Notifications</span>
                            </div>
                        </li>
                ...
                <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">
                                {{ auth()->user()->name }}</span><span class="user-status">Available</span>
                        </div>
                        <span>
                            {{-- <img 
                                class="round pro-image" 
                                src="{{ auth()->user()->getprofileImg() }}" 
                                alt="avatar"
                                height="40" width="40" 
                            /> --}}
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        {{-- <a class="dropdown-item" href="{{ route('home') }}">
                            <i --}} {{--
                                class="feather icon-user"></i> Visit Site
                        </a> --}}
                        <a class="dropdown-item d-none" href="app-email"><i class="feather icon-mail"></i> My
                            Inbox</a>
                        {{-- <a class="dropdown-item" href="javascript: void(0);" id="view-profile"><i class="fa fa-eye"></i>
                            View Profile</a> --}}
                        <a class="dropdown-item d-none" href="app-chat"><i class="feather icon-message-square"></i>
                            Chats</a>
                        {{-- <div class="dropdown-divider"></div>
                        --}}

                        <a href="{{ route('edit-profile', Auth::id()) }}" class="dropdown-item"><i
                                class="fa fa-wrench"></i>Setting</a>
                        <a href="{{ route('student.edit-profile') }}" class="dropdown-item"><i
                                class="fa fa-dot-circle-o"></i>Edit Profile</a>
