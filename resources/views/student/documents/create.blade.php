<div class="p-2 mb-2 shadow border" style="border-radius: 0.5rem; box-shadow: unset;">
    <form class="{{ !isset($other_document) ? 'add-document-form' : 'edit-document-form' }}"
        action="{{ route('student.document.upload') }}" method="post">
        @csrf
        ...
        <div class="row">
            <div class="col-md-4 col-12">
                <input required placeholder="Type Document Name..." type="text" name="document_name"
                    class="form-control" value="{{ $other_document->document_name ?? '' }}">
            </div>
            <div class="col-md-4 col-12 mt-1 mt-md-0">
                <div class="custom-file text-left">
                    <input {{ isset($other_document) ? '' : 'required' }} name="document_file" type="file"
