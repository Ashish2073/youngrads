...
==========================================================================================*/
                (function (window, document, $) {
                    ...
                    $(window).on("load", function () {
                        ...
                        $('a[data-action="collapse"]').on(
                            ...
                            function (e) {
                                ...
                                $(this)
                                    ...
                                    .collapse("toggle"); // Adding bottom padding on card collapse
                        ...
                        $(
                            ...
                            if (parseInt(card[0].style.height, 10) > 0) {
                                ...
                                if (card.data("height")) {
                                    ...
                                    card.css("height", cardHeight).attr(
                                        "data-height",
                                        ""
                                    );
                                }
                        ...
                        $(".main-menu-content")
                            .find("li.active")
                            .parents("li")
                            .addClass("sidebar-group-active"); // Add open class to parent list item if subitem is active except compact menu
                        ...
                        if (menuType == "horizontal-menu") {
                            ...
                            $(".main-menu-content")
                                .find("li.active")
                                .closest("li.nav-item")
                                .addClass("sidebar-group-active open"); // $(".main-menu-content")
                            //   .find("li.active")
                            //   .parents("li")
                            //   .addClass("active");
                        ...
                        if ($body.hasClass("boxed-layout")) {
                            if ($body.hasClass("vertical-overlay-menu")) {
                                ...
                                var menuPositionAdjust =
                                    contentPosition - menuWidth;

                                if ($body.hasClass("menu-flipped")) {
                                    mainMenu.css(
                                        "right",
                                        menuPositionAdjust + "px"
                                    );
                                } else {
                                    mainMenu.css(
                                        "left",
      ...
      */
                        ...
                        $(".content-overlay").on("click", function () {
                            ...
                            $(".bookmark-wrapper .bookmark-input").removeClass(
                                "show"
                            );
                        ...
                        if (container.length > 0) {
                            container[0].addEventListener(
                                ...
                                function () {
                                    if (
                                        $(this).find(".ps__thumb-y").position()
                                            .top > 0
                                    ) {
                                        $(".shadow-bottom").css(
                                            "display",
                    ...
                    if (typeof Hammer !== "undefined") {
                        // Swipe menu gesture
                        var swipeInElement =
                            document.querySelector(".drag-target");
                        ...
                        if ($(swipeOutOverlayElement).length > 0) {
                            var swipeOutOverlayMenu = new Hammer(
                                swipeOutOverlayElement
                            );
                    ...
                    $(".dropdown-language .dropdown-item").on(
                        "click",
                        function () {
                            var $this = $(this);
                            ...
                            var selectedFlag = $this
                                .find(".flag-icon")
                                .attr("class");
                            $("#dropdown-flag .selected-language").text(
                                selectedLang
                            );
                            $("#dropdown-flag .flag-icon")
                                .removeClass()
                                .addClass(selectedFlag); // var currentLanguage = $this.data("language");
                    ...
                    if (language !== null) {
                        ...
                        var selectedFlag = $(
                            ".dropdown-language .dropdown-item[data-language=" +
                                language +
                                "]"
                        )
                            .find(".flag-icon")
                    ...
                    if ($(".search-list-main").length) {
                        var searchListMain = new PerfectScrollbar(
                            ".search-list-main",
                            {
                                wheelPropagation: false,
                            }
                    ...
                    searchInputInputfield.on("keyup", function (e) {
                        ...
                        if (
                            ...
                            if (value != "") {
                                ...
                                if (bookmark === true) {
                                    var arrList = $(
                                            "ul.nav.navbar-nav.bookmark-iconss li"
                                        ),
                                        $arrList = "";
                                    ...
                                    for (var i = 0; i < arrList.length; i++) {
                                        ...
                                        $arrList +=
                                            ...
                                            '<div class="d-flex justify-content-start align-items-center">' +
                                            '<span class="mr-75 ' +
                                            arrList[i].firstChild.firstChild
                                                .className +
                                            '"  data-icon="' +
                                            arrList[i].firstChild.firstChild
                                                .className +
                        ...
                        function (e) {
                            ...
                            if ($(this).hasClass("warning")) {
                                ...
                                var $url = $(this).parent()[0].href,
                                    ...
                                    $icon =
                                        $(this).parent()[0].firstChild
                                            .firstChild.dataset.icon,
                                    $listItem = "",
                                    $listItemDropdown = "";
                                $listItem =
    ...
    \****************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! C:\laragon\www\young\resources\js\core\app.js */ "./resources/js/core/app.js"
                );
